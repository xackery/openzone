...
function compress3 (dest : pBytef;
                    var destLen : uLong;
                    const source : pBytef;
                    sourceLen : uLong;
                    level : int) : int;

function compress4 (dest : pBytef;
                    var destLen : uLong;
                    const source : pBytef;
                    sourceLen : uLong) : int;
...
function compress4 (dest : pBytef;
                   ...
                   sourceLen : uLong) : int;
begin
  compress4 := compress3(dest, destLen, source, sourceLen, Z_DEFAULT_COMPRESSION);
end;
