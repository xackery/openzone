...
type
  ...
  TDrawItemCaptionEvent = Procedure(Item: TTBCustomItem; Viewer: TTBItemViewer; IsRotated: Boolean; const Canvas: TCanvas; ARect: TRect; const ACaption: String; ADrawDisabledShadow: Boolean; AFormat: UINT) Of Object;
  ...
  private
    ...
    FVisible: Boolean;
    FOnPrePaint: TDrawItemCaptionEvent;
    FOnPostPaint: TDrawItemCaptionEvent;
  ...
  protected
    ...
    Procedure SetDefaultDrawing(B: Boolean); 
  ...
  public
    ...
    Property OnPrePaint: TDrawItemCaptionEvent Read FOnPrePaint Write FOnPrePaint;
    Property OnPostPaint: TDrawItemCaptionEvent Read FOnPostPaint Write FOnPostPaint;
...
Procedure TTBCustomItem.SetDefaultDrawing(B: Boolean);
Begin
  If B <> FDefaultDrawing Then
  Begin
    FDefaultDrawing := B;
    Change(True);
  End;
...
begin
  DC := Canvas.Handle;
  If (FItem <> Nil) And Assigned(FItem.OnPrePaint) Then FItem.OnPrePaint(FItem,Self,IsRotated,Canvas,ARect,ACaption,ADrawDisabledShadow,AFormat);
  If (FItem <> Nil) And FItem.DefaultDrawing Then
  Begin
  ...
  End;
  If (FItem <> Nil) And Assigned(FItem.OnPostPaint) Then FItem.OnPostPaint(FItem,Self,IsRotated,Canvas,ARect,ACaption,ADrawDisabledShadow,AFormat);
end;
