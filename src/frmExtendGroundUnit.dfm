object frmExtendGround: TfrmExtendGround
  Left = 773
  Top = 200
  Width = 262
  Height = 270
  Caption = 'frmExtendGround'
  Color = clBtnFace
  ...
  object edtExtend: TClearTypeEdit
    Left = 128
    Top = 128
    Width = 65
    Height = 24
  ...
  object cbRumple: TClearTypeCheckBox
    Left = 8
    Top = 168
    Width = 201
    Height = 17
    Caption = 'Rumple new ground areas'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
