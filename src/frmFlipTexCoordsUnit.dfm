object frmFlipTexCoords: TfrmFlipTexCoords
  Left = 505
  Top = 410
  Width = 329
  Height = 178
  Caption = 'Flip texture coordinates'
  Color = clBtnFace
  ...
  PixelsPerInch = 120
  TextHeight = 16
  object cbFlipHorizontal: TClearTypeCheckBox
    Left = 104
    Top = 24
    Width = 97
    Height = 17
  ...
  object cbFlipVertical: TClearTypeCheckBox
    Left = 104
    Top = 56
    Width = 97
    Height = 17
